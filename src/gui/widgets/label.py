...
class Label(DObject):
    def __init__(self, writer, row, col, text, invert=True, fgcolor=0, bgcolor=1, bdcolor=False):
    ...
    def value(self, text=None, invert=True, fgcolor=0, bgcolor=1, bdcolor=None):
